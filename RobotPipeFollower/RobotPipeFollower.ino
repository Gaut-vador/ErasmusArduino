...
void setup(){
  ...
  pixy.setServos(RCS_CENTER_POS - 300, RCS_CENTER_POS - 300);
...
void loop(){
  ...
  if(millis() - lastCheckTime > 1000){
    ...
    // If we detect a faillure, stop the robot, send a message 
    // and then continu
    if (blocks){
      stopRobot();
...
//---------------------------------------
// Do not allow the robot to move until 
// you call the "robotGo" function 
//---------------------------------------
void stopRobot(){
  moveOk = 0;
}
...
//---------------------------------------
// Allow the robot to move until 
// you call the "robotStop" function 
//---------------------------------------
void robotGo(){
  moveOk = 1;
}
